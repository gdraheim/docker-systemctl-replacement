...
def time_to_seconds(text: str, maximum: Optional[float] = ...) -> float: ...
...
class Systemctl:
    ...
    def wait_notify_socket(self, notify: NotifySocket, timeout: float, pid: Optional[int] = None) -> Dict[str,str]:
