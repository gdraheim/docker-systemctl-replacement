...
def only_wants_deps(deps: Dict[str, str]) -> Dict[str, str]: ...
...
class Systemctl:
    ...
    _sysinit_modules: Optional[Dict[str, Dict[str, str]]] = ...
    ...
    def write_sysinit_cache(self, deps: Dict[str, Dict[str, str]]) -> bool: ...
    def get_sysinit_deps(self, unit: str, deps_modules: Optional[Dict[str, Dict[str,str]]] = None) -> Dict[str, Dict[str, str]]: ...
    def get_sysinit_wants(self, unit: str) -> Dict[str, Dict[str, str]]:
        newresults: Dict[str, Dict[str, str]]
    def read_sysinit_cache(self) -> Optional[Dict[str, Dict[str, str]]]:
        result: Dict[str, Dict[str, str]] = ...
    ...
    def sysinit_target_conf(self) -> SystemctlConf: ...
