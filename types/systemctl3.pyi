...
class Systemctl:
    ...
    def write_deps_cache(self, deps: Dict[str, Dict[str, str]]) -> bool: ...
    ...
    def get_sysinit_deps(self, unit: str) -> Dict[str, Dict[str, str]]:
    ...
    def syntax_check_from(self, conf: SystemctlConf) -> int: ...
    ...
    def _ignored_unit(self, unit: str, ignored: str) -> Optional[str]: ...
    ...
    def kill_children_pidlist_of(self, pid: Optional[int]) -> List[int]: ...
