...
def shutil_fchown(fileno: int, user: str, group: str) -> None: ...
...
class Systemctl:
    ...
    def exec_newcmd(self, cmd: str, env: Dict[str, str], conf: Optional[SystemctlConf] = None) -> Tuple[ExecMode, List[str]]: ...
