...
from typing import Any, Callable, Dict, Iterable, List, NoReturn, Optional, TextIO, Tuple, Type, Union
...
def o99(part: str, shorter: int=...) -> str: ...
def os_path(root: Optional[str], path: str) -> str: ...
def path_replace_extension(path: str, old: str, new: str) -> str: ...
def os_getlogin() -> str: ...
def get_runtime_dir() -> str: ...
def get_home() -> str: ...
def _var_path(path: str) -> str: ...
def shutil_setuid(user: Optional[str]=..., group: Optional[str]=...) -> Dict[str, str]: ...
...
class SystemctlConf:
    ...
    def os_path_var(self, path: str) -> str: ...
    def loaded(self) -> str: ...
...
def parse_unit(name: Any) -> parse_result: ...
def time_to_seconds(text: str, maximum: Optional[int] = ...) -> int: ...
...
class Systemctl:
    ...
    def is_user_conf(self, conf : Optional[SystemctlConf]) -> bool: ...
    def not_user_conf(self, conf : Optional[SystemctlConf]) -> bool: ...
    ...
    def status_file_from(self, conf : SystemctlConf, default : Optional[str] = None) -> str: ...
    def default_status_file(self, conf : SystemctlConf) -> str: ... # -> text
    ...
    def read_status_from(self, conf : SystemctlConf, defaults: Optional[Dict[str, str]] = None) -> Dict[str, str]: 
        status: Dict[str, str]
    ...
    def get_proc_started(self, pid: int) -> float: ...
    ...
    def expand_special(self, cmd: str, conf: Optional[SystemctlConf] = None) -> str:
        def sh_escape(value: str) -> str: ...
        def get_confs(conf: Optional[SystemctlConf]) -> Dict[str, str]: ...
        def get_conf1(m: Match[str]) -> str: ...
    def exec_cmd(self, cmd: str, env: Dict[str, str], conf: Optional[SystemctlConf] = None) -> List[str]:
        def get_env1(m: Match[str]) -> str: ...
        def get_env2(m: Match[str]) -> str: ...
        newcmd: List[str]
    def path_journal_log(self, conf: SystemctlConf) -> str: ... # never None
    ...
    def read_notify_socket(self, notify: NotifySocket, timeout: int) -> str: ...
    def wait_notify_socket(self, notify: NotifySocket, timeout: int, pid: Optional[int] = None) -> Dict[str,str]:
    ...
    def get_TimeoutStartSec(self, conf: SystemctlConf) -> int: ...
    def get_SocketTimeoutSec(self, conf: SystemctlConf) -> int: ...
    ...
    def get_TimeoutStopSec(self, conf: SystemctlConf) -> int: ...
    ...
    def wait_vanished_pid(self, pid: int, timeout: int) -> bool: ...
    ...
    def system_default_services(self, sysv: str = "S", default_target: Optional[str] = None) -> List[str]: ...
    def enabled_default_services(self, sysv: str = "S", default_target: Optional[str] = None, igno: List[str] = []) -> List[str]: ...
    def enabled_default_user_local_units(self, unit_kind: str = ".service", default_target: Optional[str] = None, igno: List[str] = []) -> List[str]:
        target: str
        units: List[str]
    def enabled_default_user_system_units(self, unit_kind: str = ".service", default_target: Optional[str] = None, igno: List[str] = []) -> List[str]:
        units: List[str]
    def enabled_default_system_units(self, unit_type: str = ".service", default_target: Optional[str] = None, igno: List[str] = []) -> List[str]:
        units: List[str]
    def enabled_default_sysv_units(self, sysv: str = "S", default_target: Optional[str] = None, igno: List[str] = []) -> List[str]:
        units: List[str]
    ...
    def get_StartLimitIntervalSec(self, conf: SystemctlConf, maximum: Optional[int] = None) -> int: ...
    def get_RestartSec(self, conf: SystemctlConf, maximum: Optional[int] = None) -> int: ...
...
def print_result(result: Any) -> int:
    def logg_info(*msg: Any) -> None: ...
    def logg_debug(*msg: Any) -> None: ...
