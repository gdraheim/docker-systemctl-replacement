...
NOTE: int
DONE: int
def dbg_flock_(msg: str) -> None: ...
def dbg_killall_(msg: str) -> None: ...
def dbg_(msg: str) -> None: ...
def debug_(msg: str) -> None: ...
def hint_(msg: str) -> None: ...
def info_(msg: str) -> None: ...
def note_(msg: str) -> None: ...
def warn_(msg: str) -> None: ...
def warning_(msg: str) -> None: ...
def done_(msg: str) -> None: ...
def error_(msg: str) -> None: ...
NOT_A_PROBLEM: int
NOT_OK: int
NOT_ACTIVE: int
NOT_FOUND: int
...
class Systemctl:
    ...
    def syntax_check_unit(self, conf: SystemctlConf, section: str = "Service") -> int:
