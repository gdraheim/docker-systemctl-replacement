...
class Systemctl:
    ...
    def get_pid_file_path(self, unit : str) -> str: ...
    ...
    def is_system_running_target(self) -> Optional[str]: ...
...
def print_str_list_list(result: Union[None, List[Tuple[str]], List[Tuple[str,str]], List[Tuple[str,str,str]] ]) -> None: ...
def print_str_dict(result: Union[None, Dict[str,str]]) -> None: ...
def print_str_list_dict(result: Union[None, Dict[str,Tuple[str]], Dict[str,Tuple[str,str]], Dict[str,Tuple[str,str,str]] ]) -> None: ...
