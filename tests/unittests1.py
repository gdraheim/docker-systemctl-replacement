...
class AppUnitTest(unittest.TestCase):
    ...
    def test_1150(self) -> None:
        s20 = "0123456789" * 2
        s90 = "0123456789" * 9
        x20 = app.o30(s20)
        x90 = app.o30(s90)
        self.assertEqual(x20, s20)
        self.assertEqual(x90, "012345...901234567890123456789")
        self.assertEqual(len(x90), 30)
        n = app.o30(None) # type: ignore[arg-type]
        z = app.o30(0) # type: ignore[arg-type]
        self.assertEqual(n, None)
        self.assertEqual(z, 0)
